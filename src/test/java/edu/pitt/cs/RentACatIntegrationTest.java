...
public class RentACatIntegrationTest {
	...
	public void testGetCatNullNumCats0() {
		// TODO: Fill in
		try {
			Method m = r.getClass().getDeclaredMethod("getCat", Cat.class);
			m.setAccessible(true);
			Object ret = m.invoke(r, 2);
			assertNull(ret); // return value is null
	...
	public void testGetCatNumCats3() {
		...
		try {
			...
			m.setAccessible(true);
			Object ret = m.invoke(r, 2);
			assertNotNull(ret); // return value is null
			assertEquals(c2, ret);
		} catch (Exception e) {
			System.err.println(e);
		}
	...
	public void testRenameNumCat3() {
		...
		boolean ret = r.renameCat(2, "Garfield");
		assertTrue(ret);
		String ret_2 = c2.getName();
		assertEquals("Garfield", ret_2);
	}
